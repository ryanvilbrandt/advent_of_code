...
class TestDay11(unittest.TestCase):
    ...
    def test_run_cycle(self):
        new_grid = run_cycle(Grid.from_string(EXAMPLE))
        self.assertEqual(Grid.from_string(EXAMPLE.replace("L", "#")), new_grid)
        new_grid = run_cycle(new_grid)
        second_round = """
#.LL.L#.##
#LLLLLL.L#
L.L.L..L..
